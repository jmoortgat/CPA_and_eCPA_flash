...
In the full eCPA model (Section~\ref{sec:ecpa}), $F_1$ additionally contains
the Debye--H\"{u}ckel compressibility $Z^{\rm DH}$ and the permittivity term $Z^{\rm Perm}$,
and the relative permittivity $\varepsilon_r$ satisfying the Kirkwood implicit
equation~\citep{MaribMogensen2015} enters the coefficients; the structure of the
$3\times 3$ Newton system is otherwise unchanged.
