...
\newcommand{\authordetailsblock}{
	...
	\parbox[t]{0.48\textwidth}{\footnotesize\textit{\authordetails}}
}
...
\address{
	\includegraphics[width=.5\textwidth]{\logo} % Include the logo of author institution
	\hspace{0.82\textwidth} % Position of the institution logo, increase to move left, decrease to move right
	\vskip -0.07\textheight~\\ % Position of the large header text in relation to the institution logo, increase to move down, decrease to move up
	...
	~\\[-0.007\textheight] % Reduce the whitespace above the horizontal rule
	\hspace{0.08\textwidth}\vhrulefill{1pt} \\ % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
...
\renewcommand{\closing}[1]{
	...
	\parbox{\indentedwidth}{
		...
		\vskip 1.8cm % Whitespace between the closing text and author's name for a physical signature
