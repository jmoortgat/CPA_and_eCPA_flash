"""
plot_speedup_figures.py — CPA parameter-space scan summary figures.

Reads results/scan_results_extended.npz (written by run_parameter_scan.py)
and results/scan_v4_table.npz.

Produces, among others, the two panels of paper Figure 6:
  figures/scan/speedup_ratio_heatmap.png   (Fig. 6a — standard/accelerated SSI)
  figures/scan/stability_best_trial.png    (Fig. 6b — best stability initial guess)
Additional outputs: SSI iteration heatmaps, phase envelope, convergence summary.
"""
import numpy as np
import matplotlib
matplotlib.use("Agg")
